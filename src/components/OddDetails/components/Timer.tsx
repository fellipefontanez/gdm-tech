...
const Timer: React.FC<TimerProps> = ({ startTime }) => {
  ...
  return (
    <div className="flex flex-col mb-6 justify-self-center items-center justify-center bg-white p-6 rounded-lg h-fit w-full @md:w-[400px] border border-gray-200 shadow-sm">
      {renderContent()}
    </div>
  );
};
