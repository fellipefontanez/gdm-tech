...
export default function OddDetails({ event, isModal }: OddDetailsProps) {
  return (
    <section className="container pt-8 flex flex-col w-full items-center relative @container">
      {!isModal && <div className="absolute top-0 left-0 w-full h-[30%] bg-(--header)"></div>}
      <div className="flex flex-col p-4 bg-[#f3f3f3] rounded-lg z-50 flex-wrap">
