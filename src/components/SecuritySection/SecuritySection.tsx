...
export default function SecuritySection() {
  return (
    <section className="w-full py-20 px-4 bg-white flex flex-col items-center text-center">
      ...
      >
        Aqui, seus dados e apostas estão protegidos com as melhores práticas do mercado. Transparência em cada movimento, para você jogar com
      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        >
          ...
          <p className="text-gray-500 text-sm">Criptografia de ponta e servidores seguros para manter seus dados sempre protegidos.</p>
        </motion.div>
        ...
        >
          ...
          <p className="text-gray-500 text-sm">Histórico claro de apostas, sem surpresas ou taxas escondidas.</p>
        </motion.div>
      </div>
    </section>
  );
